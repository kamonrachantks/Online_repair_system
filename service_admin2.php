...
try {
    ...
    // Build the query to fetch appointments
            ...
            <div style="padding-top: 10px;">
                <ul class="pagination">
                    ...
                    if ($page > 1) {
                        ...
                        $prevPage = $page - 1;
                        echo '<li class="page-item"><a class="page-link" href="?page=' . $prevPage . '&startDate=' . $startDate . '&endDate=' . $endDate . '">Previous</a></li>';
                    }

                    for ($i = 1; $i <= $totalPages; $i++) {
                        echo '<li class="page-item"><a class="page-link" href="?page=' . $i . '&startDate=' . $startDate . '&endDate=' . $endDate . '">' . $i . '</a></li>';
                    }

                    if ($page < $totalPages) {
                        $nextPage = $page + 1;
                        echo '<li class="page-item"><a class="page-link" href="?page=' . $nextPage . '&startDate=' . $startDate . '&endDate=' . $endDate . '">Next</a></li>';
                        echo '<li class="page-item"><a class="page-link" href="?page=' . $totalPages . '&startDate=' . $startDate . '&endDate=' . $endDate . '">Last</a></li>';
                    }
